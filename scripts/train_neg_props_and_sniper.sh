...
# python2 main_train.py --cfg ${cfg_path} --set TRAIN.USE_NEG_CHIPS False TRAIN.ONLY_PROPOSAL True \
...
for cset in "${SETS[@]}"; do
	...
	python2 main_test.py --cfg ${cfg_path} --set TEST.EXTRACT_PROPOSALS True TEST.PROPOSAL_SAVE_PATH ${prop_save_path} \
...
python2 main_train.py --cfg ${cfg_path} --set proposal_path ${prop_save_path}
